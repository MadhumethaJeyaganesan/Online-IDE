...
/*using below we are redirecting to standard output*/
var redirectStderrToStdout = ((localStorageGetItem("redirectStderrToStdout") || "false") === "true");
var editorModeObject = null;

/*making font size as 14*/
var fontSize = 14;

/*below two are the modes of editor specified in settings*/
var MonacoVim;
var MonacoEmacs;

var layout;
/*keeping var names as below*/
var sourceEditor;
var stdinEditor;
var stdoutEditor;
var stderrEditor;
...
/*$ is typically used as a selector (i.e. a function that returns a set of elements found in the document object model*/
var $selectLanguage;
var $compilerOptions;
...
/*below are the layouts such as settings, dimension, content used in ide*/
var layoutConfig = {
    settings: {
    ...
    content: [{
        /*checks if the item is closable. If false, the x on the items tab will be hidden and container.close() will return false*/
        /*below are the ements present in ide and checking those element status*/
        type: "row",
        content: [{
            type: "component",
...
/*function to set the items from user*/
...
/*function to show the navigation messages*/
...
/*function to load those messages*/
...
/*function to show how to handle those error messages*/
function handleError(jqXHR, textStatus, errorThrown) {
    showError(`${jqXHR.statusText} (${jqXHR.status})`, `<pre>${JSON.stringify(jqXHR, null, 4)}</pre>`);
}

/*function to rectify those error messages*/ 
function handleRunError(jqXHR, textStatus, errorThrown) {
    handleError(jqXHR, textStatus, errorThrown);
    $runBtn.removeClass("loading");
}

/*function that shows how to provide proper result after error handling*/
function handleResult(data) {
    ...
    /*below if statements are to eliminate the errors and to give output*/
    if (stdout !== "") {
...
/*below function is to save the program*/
function save() {
    ...
    /*to save the file by giving specific name*/
...
/*default content for multiple languages*/
var cSource = "\
#include <stdio.h>\n\
\n\
int main(void) {\n\
